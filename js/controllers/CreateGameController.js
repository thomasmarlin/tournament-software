...
sosApp.controller('CreateGameController', ['$scope', '$uibModalInstance', '$timeout', 'ConstantsService', 'MessageBoxService', 'TournamentService', 'UtilService', function($scope, $uibModalInstance, $timeout, ConstantsService, MessageBoxService, TournamentService, UtilService) {
